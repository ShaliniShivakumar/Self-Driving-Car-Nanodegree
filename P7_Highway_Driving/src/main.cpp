...
int main() {
  ...
  //Cars starting lane (middle lane on left side of the road)
  int lane = 1;
  
  // Car reference velocity 
      ...
      if (s != "") {
        ...
        if (event == "telemetry") {
          ...
          for (int i = 0; i< sensor_fusion.size(); i++)
          {
              ...
              {
                //non the intended part of road
                //misra no else if else
              }
             ...
             double check_car_s =  sensor_fusion[i][5];
              ...
              check_car_s+= ((double)(prev_size*0.02*car_speed));
          ...
          //Do i have previous path points
          if(prev_size <2)
          {
           	//since not many previous points, based on yaw angle derive previous point
          ...
          //previous points are added to maintain continuity
          ...
          //use spline to get corresponding y
